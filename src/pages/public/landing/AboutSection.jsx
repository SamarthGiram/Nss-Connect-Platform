      ...
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        <div className="space-y-6">
          <div className="flex items-start gap-5 p-6 bg-[#fdf8f4] rounded-2xl border border-[#f0e8de]">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2 leading-relaxed">
                Launched in 1969, NSS develops the personality of students through selfless community service, inspired by Mahatma Gandhi.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-[#ef7041] text-white rounded-2xl p-5">
