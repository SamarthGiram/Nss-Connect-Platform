...
const events = [
  { day: '30', month: 'JUN', title: 'Tree Plantation Drive', venue: 'Green Park, Pune', time: '09:00 AM', tag: 'Environment' },
...
const StatsAndEvents = () => {
  ...
  return (
    <section id="events" className="py-20 bg-[#f5f7ff] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div ref={ref} className="grid md:grid-cols-3 gap-6">
          {events.map((ev, i) => {
            ...
            return (
              <div key={i} className={`bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group opacity-0 ${isVisible ? `reveal-fade-in-up ${delayClass}` : ''}`}>
                ...
                <div className="p-5 space-y-2">
                  ...
                  <Link to="/register" className="w-full block">
                    <button className="w-full mt-3 py-2.5 bg-[#eef2ff] text-[#102167] font-bold text-sm rounded-xl hover:bg-[#102167] hover:text-white transition-all duration-300 group-hover:bg-[#102167] group-hover:text-white border-none bg-transparent cursor-pointer">
                      Register Now
                    </button>
                  </Link>
                </div>
